...
class ProductController extends AbstractController
{
    ...
    public function getProducts()
    {
        ...
        return $this->json($product)->setEncodingOptions($product | JSON_PRETTY_PRINT);
    ...
    /**
     * @Route("/deleteAllDataProduct", name="deleteAllDataProduct", methods={"GET","HEAD"})
     */

    public function deleteAllDataProduct()
    {
        $entityManager = $this->getDoctrine()->getManager();
        $product = new Product();
        ...
        return $this->json([
            'message' => 'success delete all data products'            
        ]);
    }
}
